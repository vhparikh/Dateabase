          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="ml-0 md:ml-8 mt-6 md:mt-0 text-center md:text-left">
              ...
              <div className="mt-6 flex flex-wrap gap-3 justify-center md:justify-start">
                ...
                <Link 
                  to="/profile/edit" 
                  className="px-4 py-2 bg-white text-orange-600 rounded-lg border border-orange-300 shadow-sm hover:bg-orange-50 transition-colors flex items-center"
                >
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          {activeTab === 'profile' ? (
            <div>
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-medium text-gray-700 mb-2">Full Name</h3>
