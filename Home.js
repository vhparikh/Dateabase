    ...
    <div className="py-6">
      ...
      <section className="mb-12">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-800">Popular Experiences</h2>
          <a href="/experiences" className="text-orange-600 hover:text-orange-700 text-sm font-medium">
            View All
          </a>
        </div>
        
        {/* Experiences cards will go here */}
          ...
          {loading ? (
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-center">
              ...
              <button 
                ...
                className="mt-2 px-4 py-2 bg-white border border-red-300 rounded-md text-red-600 text-sm hover:bg-red-50"
              >
                Retry
              </button>
            </div>
            ...
            <div className="bg-orange-50 border border-orange-100 rounded-lg p-8 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-800 mb-2">No experiences found</h3>
              <p className="text-gray-600 mb-4">Be the first to create a new experience!</p>
              <button
                onClick={handleCreateExperienceClick}
                className="inline-block px-6 py-3 bg-gradient-to-r from-orange-start to-orange-end text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all"
              >
                Create Experience
              </button>
            </div>
              ...
              <AnimatePresence>
                {visibleExperiences.map((exp, index) => (
                  <motion.div
                    ...
                    style={{ zIndex: visibleExperiences.length - index }}
                  >
                    <ExperienceCard 
                      experience={exp} 
                      onSwipe={handleSwipe}
                      zIndex={visibleExperiences.length - index}
                    />
                  </motion.div>
                ))}
              </AnimatePresence>
              
              {popularExperiences.length > 0 && visibleExperiences.length === 0 && (
                <div className="bg-white rounded-xl shadow-lg p-8 text-center border border-orange-100">
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-orange-100 rounded-full mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-orange-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <h3 className="text-xl font-bold text-gray-800 mb-2">You've seen all experiences!</h3>
                  <p className="text-gray-600 mb-6">Looks like you've gone through all available experiences.</p>
                  <button 
      ...
      <section className="mb-12">
        <div className="flex justify-between items-center mb-6">
          ...
          <a href="/matches" className="text-orange-600 hover:text-orange-700 text-sm font-medium">
            View All
          </a>
        </div>
        ...
        {matchesLoading ? (
          <div className="flex items-center justify-center h-40">
            <div className="text-center">
              <div className="animate-spin rounded-full h-10 w-10 border-t-4 border-b-4 border-orange-500 mx-auto mb-4"></div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-orange-100 p-6 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-800 mb-1">No matches yet</h3>
