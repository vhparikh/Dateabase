...
const Experiences = () => {
  ...
  // Already defined location at the top of the component
  ...
  // Check for openAddModal query parameter to automatically open the modal
  useEffect(() => {
    const params = new URLSearchParams(location.search);
    if (params.get('openAddModal') === 'true') {
      handleAddExperience();
    }
  }, [location]);
